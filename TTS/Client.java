...
public class Client {
    ...
    public static void main(String[] args) {
        try {
            ...
            Registry registryKst = LocateRegistry.getRegistry(
                "localhost",
                1002
            );
            ...
            MatakuliahInterface matakuliahInterface =
                (MatakuliahInterface) registryMatakuliah.lookup(
                    "MatakuliahInterface"
                );
            KstInterface kstInterface = (KstInterface) registryKst.lookup(
                "KstInterface"
            );
    ...
    private static void menuKst(Scanner scanner, KstInterface service) {
        try {
            while (true) {
                System.out.println("\n--- KST ---");
                System.out.println("1. Tambah");
                ...
                switch (pilihan) {
                    case 1:
                        ...
                        System.out.println(service.tambah(nim, kodeMK));
                        break;
                    case 2:
                        System.out.println(service.lihat());
                        break;
                    ...
                    case 4:
                        ...
                        String deleteKode = scanner.nextLine();
                        System.out.println(
                            service.delete(deleteNim, deleteKode)
                        );
                        break;
                    case 0:
                        return;
